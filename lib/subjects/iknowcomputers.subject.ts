...
export const iknowcomputersSubject: Subject = {
  ...
  description: "Office computer skills course — beginner to job-ready",
  lectures: [
    {
      id: "course-structure",
  ...
  phases: [
    ...
    {
      id: "module2",
      title: "Module 2 — Internet, Email & Browsers",
      openByDefault: true,
      lectures: [
        {
          id: "ikc-2.1",
    ...
    },
    {
      ...
      lectures: [
        ...
        {
          id: "ikc-3.2",
          title: "3.2 Formatting",
          path: "docs/coding/i-know-computers/Module 3 - MS Word/3.2 Formatting.md",
        },
        {
          id: "ikc-3.3",
          title: "3.3 Tables",
          path: "docs/coding/i-know-computers/Module 3 - MS Word/3.3 Tables.md",
        },
        {
          id: "ikc-3.4",
    ...
    {
      id: "module4",
      title: "Module 4 — MS Excel (Detailed)",
      openByDefault: true,
      lectures: [
        {
          id: "ikc-4.1",
        ...
        {
          id: "ikc-4.6",
          title: "4.6 Pivot Tables",
          path: "docs/coding/i-know-computers/Module 4 - MS Excel (Detailed)/4.6 Pivot Tables.md",
        },
        {
          id: "ikc-4.7",
    ...
    {
      id: "module5",
      title: "Module 5 — PowerPoint Basics",
      openByDefault: true,
      lectures: [
        {
          id: "ikc-5.1",
    ...
    {
      id: "module6",
      title: "Module 6 — Google Workspace Basics",
      openByDefault: true,
      lectures: [
        {
          id: "ikc-6.1",
          title: "6.1 Google Drive",
          path: "docs/coding/i-know-computers/Module 6 - Google Workspace Basics/6.1 Google Drive.md",
        },
        {
          id: "ikc-6.2",
          title: "6.2 Google Sheets (vs Excel)",
          path: "docs/coding/i-know-computers/Module 6 - Google Workspace Basics/6.2 Google Sheets (vs Excel).md",
        },
        {
          id: "ikc-6.3",
    ...
    {
      id: "module7",
      title: "Module 7 — Job-Ready Office Skills",
      openByDefault: true,
      lectures: [
        {
          id: "ikc-7.1",
